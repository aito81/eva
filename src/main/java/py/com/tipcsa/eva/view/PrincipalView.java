...
public class PrincipalView extends CustomComponent implements View {
	...
	public PrincipalView() {
		...
		btn3.addClickListener(event -> EvaUI.getCurrent().getNavigator().navigateTo("altaUsuario"));
		listBtn.add(btn3);
		
		btn4.addClickListener(event -> EvaUI.getCurrent().getNavigator().navigateTo("usuario"));
		btn4.addStyleName(ValoTheme.BUTTON_DANGER);
		
		//botonLayout.addComponent(btn4);
		
		btn5.addClickListener(event -> EvaUI.getCurrent().getNavigator().navigateTo("altaCargo"));
		...
		btn6.addClickListener(event -> EvaUI.getCurrent().getNavigator().navigateTo("cargo"));
		btn6.setStyleName(ValoTheme.BUTTON_DANGER);
		listBtn.add(btn6);
		
		
		btn7.addClickListener(e -> EvaUI.getCurrent().getNavigator().navigateTo("altaArea"));
